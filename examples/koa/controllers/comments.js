...
export let show = function *() {
  ...
  let path = this.urlHelpers.post_comment_path(this.params.post_id, this.params.id);
...
export let edit = function *() {
  ...
  let path = this.urlHelpers.edit_post_comment_path(this.params.post_id, this.params.id);
