  ...
  _to5Helpers.prototypeProperties(Scoping, null, {
    scope: {
      value: function scope() {
        ...
        if (!_to5Helpers.hasOwn.call(options, "constraints")) options.constraints = create(null);
        ...
        if (isObject(options.constraints)) {
          ...
          options.defaults = _core.Object.assign(defaults, options.defaults || create(null));
        } else {
    ...
    controller: {
      value: function controller(controller, _x, cb) {
        var options = arguments[1] === undefined ? create(null) : arguments[1];
    ...
    constraints: {
      value: function constraints(_x, cb) {
        var constraints = arguments[0] === undefined ? create(null) : arguments[0];
    ...
    defaults: {
      value: function defaults(_x, cb) {
        var defaults = arguments[0] === undefined ? create(null) : arguments[0];
