...
var _objectGetprototypesof = require('object-getprototypesof');

var _objectGetprototypesof2 = _interopRequireDefault(_objectGetprototypesof);
...
let RouteMapper = (function (_Http) {
  ...
  RouteMapper.prototype.draw = function draw(filename) {
    ...
    let arr = _objectGetprototypesof2['default'](g);
    arr.forEach(function (p) {
      let keys = Object.keys(p);
      keys.forEach(function (m) {
        if (_lodash2['default'].isFunction(p[m])) g[m] = p[m].bind(_this17);
      });
    });
