...
var _mergeScope2 = _interopRequireDefault(_mergeScope);
...
let RouteMapper = (function () {
  ...
  RouteMapper.prototype.controller = function controller(_controller, _x2, cb) {
  ...
  RouteMapper.prototype.namespace = function namespace() {
    ...
    function _namespace(path, _x4, cb) {
      let options = arguments[1] === undefined ? {} : arguments[1];
  ...
  RouteMapper.prototype.constraints = function constraints(_x5, cb) {
    let _constraints = arguments[0] === undefined ? {} : arguments[0];

    return this.scope({ constraints: _constraints }, cb);
  };

  RouteMapper.prototype.defaults = function defaults(_x6, cb) {
    let _defaults = arguments[0] === undefined ? {} : arguments[0];

    return this.scope({ defaults: _defaults }, cb);
  };
...
// Delegates
_delegates2['default'](RouteMapper.prototype, '$scope').getter('isResources').getter('isNestedScope').getter('isResourceScope').getter('isResourceMethodScope');
