...
var noop = _babelHelpers.interopRequire(require("lodash-node/modern/utility/noop"));
...
var escape = _babelHelpers.interopRequire(require("lodash-node/modern/string/escape"));
...
var Routes = _babelHelpers.interopRequire(require("./routes"));
...
var RouteMapper = (function () {
  function RouteMapper() {
    ...
    _babelHelpers.classCallCheck(this, RouteMapper);
  ...
  _babelHelpers.prototypeProperties(RouteMapper, null, {
    routes: {
      get: function () {
