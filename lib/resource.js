...
var Resource = (function () {
  function Resource(entities, options) {
    _babelHelpers.classCallCheck(this, Resource);
  ...
  _babelHelpers.prototypeProperties(Resource, null, {
    defaultActions: {
      get: function () {
        return ACTIONS;
      },
    ...
    plural: {
      get: function () {
        ...
        return (_ref = this, !_babelHelpers.hasOwn.call(_ref, "_plural") && (_ref._plural = this.name), _ref._plural);
      },
      configurable: true
    },
    singular: {
      get: function () {
        ...
        return (_ref = this, !_babelHelpers.hasOwn.call(_ref, "_singular") && (_ref._singular = singular(this.name)), _ref._singular);
      },
      configurable: true
    },
    memberName: {
